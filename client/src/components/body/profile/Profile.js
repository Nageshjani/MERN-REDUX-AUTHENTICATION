...
const Profile = () => {
    ...
    const updatePassword = () => {
        ...
        try {
            userRequest.post('user/reset', {password},{
                headers: {Authorization: token}
            })
    ...
    const changeAvatar = async(e) => {
        ...
        try {
            ...
            const res = await userRequest.post('api/upload_avatar', formData, {
                    ...
                    <div className="col-left">
                        ...
                        <div className="avatar">
                            ...
                            <span>
                                ...
                                <p>Change</p>
                                <input type="file" onChange={changeAvatar} name="file" id="file_up" />
                            </span>
                        </div>
